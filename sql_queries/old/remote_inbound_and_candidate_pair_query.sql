...
AND
("type" = 'remote-inbound-rtp' or "type" = 'candidate-pair' or "type" = 'remote-outbound-rtp')
...
nullif(cc.packetslost_sec, 0) / (cc.packetssent + cc.packetslost_sec) as packetssentlost_pct,
nullif(cc.packetslost_sec, 0) / (cc.packetsreceived + cc.packetslost_sec) as packetsreceivedlost_pct,
