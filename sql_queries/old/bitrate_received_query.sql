...
SELECT
testid,
avg(bitsreceived_sec) as bitsreceived_avg,
min(bitsreceived_sec) as bitsreceived_min,
max(bitsreceived_sec) as bitsreceived_max,
avg(bitsssent_sec) as bitssent_avg,
min(bitsssent_sec) as bitssent_min,
max(bitsssent_sec) as bitssent_max
